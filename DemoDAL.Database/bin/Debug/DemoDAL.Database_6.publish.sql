...
GO
PRINT N'Création de [dbo].[Product]...';
...
CREATE TABLE [dbo].[Product] (
    ...
    PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [UK_Product_EAN] UNIQUE NONCLUSTERED ([EAN13] ASC)
);


GO
PRINT N'Création de [dbo].[FK_Product_Brand]...';


GO
ALTER TABLE [dbo].[Product]
    ADD CONSTRAINT [FK_Product_Brand] FOREIGN KEY ([BrandId]) REFERENCES [dbo].[Brand] ([Id]);
...
END
GO
PRINT N'Création de [dbo].[AddProduct]...';
...
END
GO
PRINT N'Création de [dbo].[DeleteProduct]...';
...
END
GO
PRINT N'Création de [dbo].[GetAllProduct]...';
...
END
GO
PRINT N'Création de [dbo].[GetProductByBrandId]...';
...
END
GO
PRINT N'Création de [dbo].[GetProductById]...';
...
END
GO
PRINT N'Création de [dbo].[UpdateProduct]...';
